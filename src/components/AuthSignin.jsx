  ...
  const gitSignin = () => {
    ...
    signInWithPopup(auth, provider)
      .then((result) => {
        ...
        dispatch({
          type: "openModal",
          payload: `Authenticated as ${user.login}`,
        });
        console.log(user);
        // ...
      })
  ...
  return (
    <div className="w-full">
      ...
      <div
        ...
        className="w-full bg-[#5DCB89] px-2 h-[40px] border-2 mt-4 flex items-center rounded"
      >
      ...
      >
        <BsGithub className="text-black text-[24px]" />
        <button
          type="button"
          onClick={gitSignin}
          className="outline-none w-full h-full"
